...
class WEATHER_Dialog : public QDialog
{
    Q_OBJECT

public:
    explicit WEATHER_Dialog(QStringList list_h, QStringList list_present,QStringList list_bd,QSqlDatabase db, QWidget *parent = nullptr);
    ~WEATHER_Dialog();
    QStringList list_BD;
