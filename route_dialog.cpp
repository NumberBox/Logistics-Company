...
ROUTE_Dialog::ROUTE_Dialog(QStringList list_h,QStringList list_present,QStringList list_bd,QSqlDatabase db,QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ROUTE_Dialog)
{
    ui->setupUi(this);
...
void ROUTE_Dialog::on_pushButton_clicked()
{
    this->close();
}

void ROUTE_Dialog::on_pushButton_2_clicked()//добавить сохранить
{
...
void ROUTE_Dialog::on_pushButton_3_clicked()//delete
{
     db2.open();
     QSqlQuery a_query;
     QString str = "";
